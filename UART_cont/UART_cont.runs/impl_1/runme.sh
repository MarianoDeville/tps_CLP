...
HD_PWD='E:/Facultad/CLP/tps_CLP/UART_cont/UART_cont.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_cont_top_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_cont_top_VIO.tcl -notrace
