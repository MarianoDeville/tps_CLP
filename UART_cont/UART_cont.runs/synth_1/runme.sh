...
HD_PWD='E:/Facultad/CLP/tps_CLP/UART_cont/UART_cont.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_cont_top_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_cont_top_VIO.tcl
